...
public class LinearEquation {
    private static final myPoint[] p = null;
    private double a;
    private double b;
    private double c;
    private double d;
    ...
    public static LinearEquation getIntersectingPoint(myPoint p1, myPoint p2, myPoint p3, myPoint p4){
        return getIntersectingPoint(p1.x(), p1.y(), p2.x(), p2.y(), p3.x(), p3.y(), p4.x(), p4.y());
    }
    ...
    public static LinearEquation getIntersectionPoint(double[][] points){
